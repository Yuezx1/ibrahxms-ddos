# ibrahxms-ddos
ibrahxmsddos.py is a Python application with a graphical user interface built using PyQt5. It combines network-related features with a modern GUI design.
